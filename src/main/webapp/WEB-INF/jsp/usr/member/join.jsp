			...
			<table class="join-box table-box-1" border="1">
				<tbody>
					...
					<tr>
						<th>이름</th>
						<td>
							<input autocomplete="off" type="text" placeholder="이름을 입력해주세요" name="name" />
						</td>
					</tr>
					<tr>
						<th>닉네임</th>
						<td>
							<input autocomplete="off" type="text" placeholder="닉네임을 입력해주세요" name="nickname" />
						</td>
					</tr>
					<tr>
						<th>전화번호</th>
					...
					<tr>
						<th>이메일</th>
						<td>
							<input autocomplete="off" type="text" placeholder="이메일을 입력해주세요" name="email" />
						</td>
					</tr>
