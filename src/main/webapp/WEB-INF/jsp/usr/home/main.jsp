...
<div
	style="width: 1920px; height: 1080px; position: relative; overflow: hidden; background: #fff; border-width: 3px; border-color: #000;">
	<div
		style="width: 278px; height: 766px; position: absolute; left: -2px; top: 312px; background: rgba(198, 171, 203, 0.8);"></div>
	<div style="width: 1000px; height: 60px;">
		<div
			style="width: 1000px; height: 60px; position: absolute; left: 448px; top: 119px; border-radius: 30px; background: #fff; border-width: 2px; border-color: #5f3976;"></div>
		<p
			style="width: 467.5px; height: 24px; position: absolute; left: 501.5px; top: 138px; opacity: 0.4; font-size: 20px; text-align: left; color: #000;">
			검색어를 입력하세요.</p>
		<img src="돋보기-이미지.png"
			style="width: 50px; height: 50px; position: absolute; left: 1373.5px; top: 124.5px; object-fit: contain;" />
	</div>
	<div style="width: 278px; height: 467.67px;">
		<div style="width: 278px; height: 72px; position: absolute; left: -0.5px; top: 243.5px; background: #4f265e;"></div>
		<p
			style="width: 201px; height: 396.67px; position: absolute; left: 52px; top: 315px; font-size: 24px; text-align: left; color: #000;">
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">개꿈(잡몽)</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">악몽(나이트메어)</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">예지몽(현몽)</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">자각몽(루시드
				드림)</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">태몽</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">가위(수면마비)</span>
			<br />
			<span style="width: 201px; height: 396.67px; font-size: 24px; text-align: left; color: #000;">거짓 깨어남</span>
		</p>
		<div
			style="display: flex; flex-direction: column; justify-content: flex-start; align-items: flex-start; position: absolute; left: 22px; top: 319px; gap: 10px;">
			<img src="개꿈-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="악몽-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="예지몽-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="자각몽-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="태몽-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="가위-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
			<img src="거짓-깨어남-이미지.png" style="flex-grow: 0; flex-shrink: 0; width: 20px; height: 40.25px; object-fit: contain;" />
		</div>
		<p style="position: absolute; left: 22px; top: 255px; font-size: 42px; text-align: left; color: #000;">게시판</p>
	</div>
	<div
	...
	<div
		...
		<div
          ...
          <line x1="0.000434782" y1="0.5" x2="1150" y2="1.5" stroke="black"></line>
				...
				<p style="position: absolute; left: 9px; top: 88px; font-size: 24px; text-align: left; color: #000;">
					[잡몽]하늘 날아다니는 꿈 꿨다 ㄷㄷ.. [5]</p>
				<p style="position: absolute; left: 9px; top: 288px; font-size: 24px; text-align: left; color: #000;">
					[잡몽]술먹는 꿈 [2]</p>
				<p style="position: absolute; left: 9px; top: 237px; font-size: 24px; text-align: left; color: #000;">
					[잡몽]방가링 [1]</p>
				<p style="position: absolute; left: 9px; top: 188px; font-size: 24px; text-align: left; color: #000;">
					[잡몽]꿈에서 여행다녀옴</p>
				<p style="position: absolute; left: 9px; top: 139px; font-size: 24px; text-align: left; color: #000;">
					[가위]가위눌림 [3]</p>
			</div>
	...
	<div style="width: 358px; height: 150px;">
		<p
			style="width: 158px; height: 100px; position: absolute; left: 247px; top: 100px; font-size: 60px; text-align: left; color: #fff;">
		...
		<img src="image-10.png"
			style="width: 200px; height: 139.21px; position: absolute; left: 46.5px; top: 49.5px; object-fit: cover;" />
	</div>
	<div
